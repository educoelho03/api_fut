...
public class ClassificacaoEntityMapperImpl implements ClassificacaoEntityMapper {
    ...
    public ClassificacaoDTO convertToDto(ClassificacaoEntity clubeEntity) {
        ...
        ClubeEntity clube = null;

        ClassificacaoDTO classificacaoDTO = new ClassificacaoDTO( posicao, clube, pontos, partidasJogadas, vitorias, empates, derrotas, golsMarcados, golsSofridos );
